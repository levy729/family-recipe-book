...
import { generateRecipeMarkdown, parseRecipeMarkdown, generateRecipeFilename } from './recipe-parser';

/**
 * Saves a recipe to a markdown file
 */
export async function saveRecipe(data: RecipeFormData): Promise<{ success: boolean; message: string; filename?: string }> {
  try {
 ...
 */
export async function loadRecipeFromFile(file: File): Promise<{ success: boolean; data?: RecipeFormData; message: string }> {
  try {
    // Validate file type
 ...
 */
export async function getAvailableRecipes(): Promise<{ filename: string; title: string; slug: string }[]> {
 ...
 */
export async function createBackup(filename: string): Promise<{ success: boolean; message: string }> {
  try {
